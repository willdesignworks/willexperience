    ...
    <section id="about">
      ...
      <div className="container about__container">
        ...
        <div className="about__content">
          ...
          <p>
            工作負責網站的維運、改版，活動網頁的規劃、開發，風格設計。
            <br />
            專長是設計、切版、UI / UX、HTML、CSS3、JavaScript、Bootstrap。
          </p>

          <p>
            從設計轉型為工程師，我擁有深厚的 UI
            設計背景，能夠將使用者需求與技術實現結合，優化使用者體驗。
            我擅長在設計與開發之間架起橋梁，提升團隊協作與溝通效率。
          </p>

          <p>
            此外，我也懂一些 UX 分析能力，使用者行為模式分析及Google
            Analytics（GA）追蹤等工具，
            能從使用者角度理解需求，優化體驗並提升產品的易用性。這些能力幫助我在跨部門協作中，更有效推動業務增長。
          </p>

          <p>
            2024年7月，開始學習React前端框架，在學習過程中，專注於React的核心跟git的部屬，
            雖然目前缺乏實際的工作經驗，但我有信心將新技能應用到實際專案中，並且不斷嘗試新技術，為公司帶來更好的用戶體驗。
          </p>

          <p>以下是目前學會的技術</p>

          <p>Vue 3 Composition API、Vite 開發、模組化元件開發</p>

          <p>
            Vue Router、Props 傳遞、Emit 接收、Pinia 狀態管理、v-model 雙向綁定
          </p>

          <p>React Router、Props 與 Callback 傳遞、Redux Toolkit 狀態管理、</p>

          <p>Axios + async/await 處理 API。</p>

          <p>
            未來計畫繼續深化Node、Native、Nuxt、Next的技術發展，並期待能在這些領域中成長與發展。
          </p>
