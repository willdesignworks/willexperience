...
const Portfolio = () => {
  ...
  const soloProjects = [
    ...
    },
    {
      ...
      title: "web design",
      img: IMG2,
      description: "專注切版開發、UI設計與UX規劃，打造流暢且高效的使用者體驗。",
    ...
    },
    {
      ...
      img: IMG3,
      description:
        "提升活動網站的設計與UX，同時優化SEO，確保吸引目光並提升搜尋排名。",
    ...
    },
    {
      ...
      img: IMG4,
      description:
        "台鐵e訂通是台灣鐵路管理局官方的手機應用程式，提供旅客便捷的訂票、查詢、服務等功能。",
    ...
    },
    {
      ...
      title: "web design",
      img: IMG5,
      description: "簡單講解一些，我在設計網頁，參考的數據過程。",
            ...
            <div className="portfolio__item-cta">
              ...
              {pro.isInternal ? (
                <Link
                  ...
                  onClick={(e) => {
                    /*
                    e.preventDefault(); // 防止 React Router 處理
                    window.location.href = `${pro.link}/${pro.id}`; // 強制刷新頁面
                    */
                  }}
                >
